...
# A starting player has an advantage, so when they win, they’ll have placed more
# marks than their opponent. Conversely, the second player is at a disadvantage,
# so they can only win the game by making an equal number of moves as the
# starting player.
